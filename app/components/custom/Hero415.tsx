...
export function Hero415(){
    return (
        ...
        bg-[url('/textures/moon.jpg')] bg-size-[1500px_auto] bg-position-[650px_700px] bg-opacity-[0.9]
        transition-all duration-10000 hover:bg-position-[700px_650px] ease-in-out">
            <div id="title header" className="flex flex-row items-center justify-center max-w-full h-24">
                <h1 className="text-8xl! font-monorama bg-[url('/textures/ink_splash_duotone.jpg')] 
                bg-size-[1000px_auto] bg-position-[0px_0px] bg-clip-text text-transparent">415 INDUSTRIES</h1>
            </div>
        </section>
    );
}